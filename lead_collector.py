...
NICHE_ALIASES: dict[str, tuple[tuple[str, ...], tuple[str, ...]]] = {
    ...
    "б'юті": (("beauty_salon",), ("%beauty_salon%",)),
    "б'юті сфера": (("beauty_salon",), ("%beauty_salon%",)),
    "б'юті сфери": (("beauty_salon",), ("%beauty_salon%",)),
    "б'юті салон": (("beauty_salon",), ("%beauty_salon%",)),
    "б'юті салони": (("beauty_salon",), ("%beauty_salon%",)),
    ...
    "детейлінг": (("auto_detailing", "car_detailing", "car_wash"), ()),
    "полірування": (("auto_detailing", "car_detailing"), ()),
    "хімчистка авто": (("auto_detailing", "car_wash"), ()),
    "тату-салон": (("tattoo", "tattoo_parlor"), ()),
    "тату-салони": (("tattoo", "tattoo_parlor"), ()),
    "тату": (("tattoo", "tattoo_parlor"), ()),
    "масажні салони": (("massage", "massage_therapy"), ()),
    "спа": (("spa",), ()),
    "spa": (("spa",), ()),
